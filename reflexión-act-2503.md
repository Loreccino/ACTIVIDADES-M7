...
_)solo hice esta parte porque siento que esta actividad es idéntica a la AE-4)_

__Preguntas de reflexión:__

___1. ¿Qué ventajas ofrece Django ORM frente a la modificación manual de esquemas
en SQL?___
...
___2. ¿Qué riesgos evita el uso de migraciones incrementales?___
...
___3. ¿Por qué es importante versionar los archivos de migración en un proyecto
compartido?___
